...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ORqSqtBZ.mjs");
...
var manifest = {
	"3b7eee93a4e69e29a61c0b6c91b331a3ef8d6d5e948a80574cd49e6ab1a6743b": {
		functionName: "getBoard_createServerFn_handler",
		importer: () => import("./api-D2Fuk2q5.mjs")
	},
	"96392e9864ff476ae897b97d23a2f627a563f714a51061469015b03996be45fd": {
		functionName: "createIntent_createServerFn_handler",
		importer: () => import("./api-D2Fuk2q5.mjs")
	},
	"a708ae0d3631db7ed5e84707675856a974396006850cead03b08225d79c01196": {
		functionName: "getIntent_createServerFn_handler",
		importer: () => import("./api-D2Fuk2q5.mjs")
	},
	"d6efc0ddda07b986c9691db394df4e0b3a30ca9fa9a4a2f89c1617905d59179e": {
		functionName: "getBrand_createServerFn_handler",
		importer: () => import("./api-D2Fuk2q5.mjs")
	},
	"f734fd279e0e5ce2461dc9853f0f84f9e6fc88143282caf7241d2d6202ef436a": {
		functionName: "confirmPay_createServerFn_handler",
		importer: () => import("./api-D2Fuk2q5.mjs")
	},
	"f99e897e2f1a11e595879b888e035b8cff95d3293348ca99959c58ba21ecfe50": {
		functionName: "getHall_createServerFn_handler",
		importer: () => import("./api-D2Fuk2q5.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BI2doANS.mjs").then((n) => n.t),
